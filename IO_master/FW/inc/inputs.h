...
extern byte outp[64];      // leds states for program (blinking codes)
extern byte HCdataout[8];      // leds states for program (blinking codes)
//extern byte outp_shadow[6];      // leds states for pins
